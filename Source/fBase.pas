...
const
  ...
  CM_TERMINATE = WM_USER + 111;
  CM_POST_AFTEREXECUTESQL = WM_USER + 112;
  CM_POST_RESIZE = WM_USER + 113;
  CM_POST_SHOW = WM_USER + 114;
  CM_RENAME = WM_USER + 115;
  CM_UPDATEPROGRESSINFO = WM_USER + 116;
  CM_UPDATETOOLBAR = WM_USER + 117;
