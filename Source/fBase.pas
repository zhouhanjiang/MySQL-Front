...
const
  ...
  UM_CLOSE_TAB = WM_USER + 103;
  UM_CLOSE_TAB_QUERY = WM_USER + 104;
  UM_DEACTIVATETAB = WM_USER + 105;
  UM_DEACTIVATEFRAME = WM_USER + 106;
  UM_EXECUTE = WM_USER + 107;
  UM_TERMINATE = WM_USER + 108;
  UM_POST_AFTEREXECUTESQL = WM_USER + 109;
  UM_POST_RESIZE = WM_USER + 110;
  UM_POST_SHOW = WM_USER + 111;
  UM_RENAME = WM_USER + 112;
  UM_UPDATEPROGRESSINFO = WM_USER + 113;
  UM_UPDATETOOLBAR = WM_USER + 114;
